...
{{--    <script src='/socket.io/socket.io.js'></script>--}}
    ...
    <script type="module" src='{{asset("assets/js/rtc.js")}}'></script>
    <script type="module" src='{{asset("assets/js/events.js")}}'></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/webrtc-adapter/7.3.0/adapter.min.js" integrity="sha256-2qQheewaqnZlXJ3RJRghVUwD/3fD9HNqxh4C+zvgmF4=" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.24.0/moment.min.js"></script>
    <script src='https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/1.3.8/FileSaver.min.js'></script>
    <script src='https://cdn.rawgit.com/yahoo/xss-filters/master/dist/xss-filters.js'></script>
    <script src='{{asset("assets/js/autolink.js")}}'></script>
</head>
...
<div class="container-fluid" id='room-create' hidden>
    ...
    <div class="row mt-2">
        ...
        <div class="col-12 col-md-4 offset-md-4 mb-3">
            ...
            <input type="text" id='room-name' value="hh" class="form-control rounded-0" placeholder="Room Name">
        </div>

        <div class="col-12 col-md-4 offset-md-4 mb-3">
            <label for="your-name">Your Name</label>
            <input type="text" id='your-name'  value="mohamed" class="form-control rounded-0" placeholder="Your Name">
        </div>
...
<div class="container-fluid" id='username-set' hidden>
    ...
    <div class="row mt-2">
        ...
        <div class="col-12 col-md-4 offset-md-4 mb-3">
            ...
            <input type="text" id='username' value="mohamed" class="form-control rounded-0" placeholder="Your Name">
        </div>
